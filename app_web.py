...
Versão: V20.2 (Módulo de Autocadastro - Correção do Bloco de Texto)
Ano: 2026
"""
...
if st.session_state["usuario_logado"] is None:
    ...
    # LÓGICA DA ABA 5: DOCUMENTAÇÃO ACADÊMICA (REFEITA EM STRINGS INDIVIDUAIS COMPLETAMENTE SEGURA)
    with aba5:
        ...
        st.markdown("* **Estruturas de Dados Avançadas:** Utilização de vetores e arranjos multidimensionais (matrizes dinâmicas do tipo List of Lists) manipuladas e remapeadas através de compreensões de listas lineares.")
